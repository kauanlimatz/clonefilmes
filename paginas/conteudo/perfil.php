          ...
          try {
            ...
            <div class="card">
              ...
              if ($show->foto_user == 'avatar-padrao.png') {
                ...
                echo '<img src="../img/avatar_p/' . $show->foto_user . '" alt="' . $show->foto_user . '" title="' . $show->foto_user . '" style="width: 200px; border-radius: 100%; margin-top: 30px">';
              } else {
                  // Exibe a imagem do usuário
                  echo '<img src="../img/user/' . $show->foto_user . '" alt="' . $show->foto_user . '" title="' . $show->foto_user . '" style="width: 200px; border-radius: 100%; margin-top: 30px">';
              }
              ?>
